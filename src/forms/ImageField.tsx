...
export default function ImageField(props: imageFieldProps) {
    ...
    const handleOnChange = (eventsArgs: ChangeEvent<HTMLInputElement>) => {
        if (eventsArgs.currentTarget.files) { //to check if a file was selected
            ...
            if (file) {
                ...
                setImageURL(''); //when a file is selected its best to set this as null
            } else {
                setImageBase64(''); // this can be because a user tried to upload then cancelled
            }
        }
    }
...
// Becasue of the formik, whatever image selected here is passed to/or accessble to the parent ActorForm 