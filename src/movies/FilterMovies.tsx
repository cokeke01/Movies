...
export default function FilterMovies() {
  ...
  //get the list of Genre for our List
  useEffect(() => {
    axios
      .get(`${urlGenres}/all`)
  ...
  //to capture the list of any selected filter item and include in the web parameter so that we have same view when page is refreshed
